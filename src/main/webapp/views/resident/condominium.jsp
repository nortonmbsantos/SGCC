				...
				<div
					...
					<div class="jumbotron">
						...
						<a class="btn btn-primary btn-sm"
							...
							<a class="btn btn-primary btn-sm"
							href="${pageContext.request.contextPath}/resident/condominium/booking/list?idCondominium=${condominium.id}"
							role="button">Minhas reservas</a> 
							<a class="btn btn-primary btn-sm"
							href="${pageContext.request.contextPath}/resident/condominium/booking/new?idCondominium=${condominium.id}"
